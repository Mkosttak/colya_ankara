...
from .views import (
    ...
    add_brand, add_category, admin_users_list, admin_user_delete, admin_user_update, add_medicine_brand,
    get_districts_ajax
)
...
urlpatterns += [
    ...
    path('admin/users/<int:pk>/update/', admin_user_update, name='admin_user_update'),
