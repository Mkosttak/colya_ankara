# users/turkey_data.py (Yeni Dosya)
...
DISTRICTS = {
    ...
    'Edirne': ['Enez', 'Havsa', 'İpsala', 'Keşan', 'Lalapaşa', 'Meriç', 'Uzunköprü', 'Süloğlu', 'Edirne'],
    ...
    'Sivas': ['Akıncılar', 'Altınyayla', 'Divriği', 'Doğanşar', 'Gemerek', 'Gölova', 'Hafik', 'İmranlı', 'Kangal', 'Koyulhisar', 'Sivas', 'Suşehri', 'Şarkışla', 'Ulaş', 'Yıldızeli', 'Zara', 'Gürün'],
...
def get_districts(city):
    """Verilen şehre ait ilçeleri döndürür."""
